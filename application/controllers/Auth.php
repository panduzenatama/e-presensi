...
class Auth extends CI_Controller
{
    ...
    public function exampleemail()
    {
        ...
        $config = [
            ...
            'smtp_user' => 'email-anda@gmail.com', // GANTI dengan email SMTP Anda
            'smtp_pass' => 'password-email-anda', // GANTI dengan password SMTP Anda
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('email-anda@gmail.com', 'E-Presensi'); // GANTI dengan email SMTP Anda
        $this->email->to($email);
