                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-responsive nowrap">
                                    ...
                                    <tbody id="tbody-data-kelas">
                                        <tr>
                                            <td><input type="text" name="kode_kelas[]" placeholder="kode kelas" style="border: none; background: transparent; text-align: center;" autocomplete="off" required></td>
                                            <td><input type="text" name="nama_kelas[]" placeholder="Nama Kelas" style="border: none; background: transparent; text-align: center;" autocomplete="off" required></td>
                                            <td></td>
                                        </tr>
                                    </tbody>
                                </table>
